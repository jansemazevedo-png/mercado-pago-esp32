...
if not order_id:
    ...
    return jsonify({
        ...
        "exemplo": "/status-order?order_id=ORD..."
    }), 400
...
# --------------------------------------
# Verifica se existe pagamento guardado
# --------------------------------------
...
if nova_cobranca:
    ...
    print(
        "ERRO AO PREPARAR PRÓXIMA COBRANÇA."
    )
